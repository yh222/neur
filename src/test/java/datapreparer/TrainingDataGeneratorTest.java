...
import core.GlobalConfigs.TRAINIG_VALUES;
...
//    }
    ...
    public void addRawTrend() {
        try {
            ...
            method.invoke(tdg, "2005-12-23", raw_data_map, storage_row, 0, 0, TRAINIG_VALUES.RAWTREND_0d.index());
            System.out.println(storage_row[TRAINIG_VALUES.RAWTREND_0d.index()]);
            assertTrue(storage_row[TRAINIG_VALUES.RAWTREND_0d.index()] == (116.56 - 117.38) / 117.38);
            method.invoke(tdg, "2005-12-23", raw_data_map, storage_row, 1, 0, TRAINIG_VALUES.RAWTREND_1d.index());
            System.out.println(storage_row[TRAINIG_VALUES.RAWTREND_1d.index()]);
            assertTrue(storage_row[TRAINIG_VALUES.RAWTREND_1d.index()] == (112.62 - 113.56) / 113.56); //-0.0082775625220148
            method.invoke(tdg, "2005-12-23", raw_data_map, storage_row, 3, 3, TRAINIG_VALUES.RAWTREND_3d.index());
            System.out.println(storage_row[TRAINIG_VALUES.RAWTREND_3d.index()]);
            assertTrue(storage_row[TRAINIG_VALUES.RAWTREND_3d.index()] == (116.56 - 110.56) / 110.56); //0.0542691751085384
