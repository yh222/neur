            ...
            try {
                ...
                try (PrintWriter writer = new PrintWriter(new BufferedWriter(
                    ...
                    for (int j = temp.size() - 1; j >= 0; j--) {
                        String new_line = handleStockSplit(temp.get(j));
